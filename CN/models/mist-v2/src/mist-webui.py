        ...
        with gr.Column():
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    data_path = gr.Textbox(label="Data Path", lines=1, placeholder="Path to your images", value="data/img")
                    output_path = gr.Textbox(label="Output Path", lines=1, placeholder="Path to store the outputs", value="output")
                    model_path = gr.Textbox(label="Target Model Path", lines=1, placeholder="Path to the target model", value="stable-diffusion/stable-diffusion-1-5")
                    class_path = gr.Textbox(label="Path to place contrast images", lines=1, placeholder="Path to place constast images", value="data/contrast")
                    prompt = gr.Textbox(label="Prompt", lines=1, placeholder="Describe your images", value="masterpiece, best quality")
